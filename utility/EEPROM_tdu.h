...
struct EEPROMClass{
    ...
    uint16_t length()                    { return EEPROMSizeGet() + 1; }
...
extern void EEPROMRead(uint32_t *pui32Data, uint32_t ui32Address, uint32_t ui32Count);

extern uint32_t EEPROMProgram(uint32_t *pui32Data, uint32_t ui32Address, uint32_t ui32Count);
extern uint32_t EEPROMProgramNonBlocking(uint32_t ui32Data, uint32_t ui32Address);
...
extern uint32_t EEPROMBlockPasswordSet(uint32_t ui32Block, uint32_t *pui32Password, uint32_t ui32Count);
extern uint32_t EEPROMBlockLock(uint32_t ui32Block);
extern uint32_t EEPROMBlockUnlock(uint32_t ui32Block, uint32_t *pui32Password, uint32_t ui32Count);
