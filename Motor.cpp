...
#include "timer_isr.h"  //activity LED prototype

Motor::Motor(){

  _attachedState = 0;

  LED_set(LED_BLUE, 0);   // reset movement: RED led
...
void Motor::attach(){
    _attachedState = 1;
    LED_set(LED_BLUE, 1);   // start movement: BLUE led
}
...
void Motor::detach(){
    ...
    _attachedState = 0;
    LED_set(LED_BLUE, 0);   // stop movement: BLUE led
}
